...
**Layout note (May 2026+):** The **138**-file count reflects this **2026-04-03** pass only. Current regen commands and folder layout are in **README.md** and **audit_reports/hard_audit_corpus_run.md** (including flat **`generated/samples/`** for **`--write-samples`**); substantive posture is summarized in **audit_reports/senior_dgcl_audit_2026-05-08.md**.
