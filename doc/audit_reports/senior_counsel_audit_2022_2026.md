...
| **YELLOW** | **Book risk** remains for **material** transactions (**§220** depth) and **DRS** exhibit/notice execution. **Hippo / Ritual / TeamBoost**: AGM cross-reference now distinguishes **filing upon execution** unless `sole_stockholder_consent_exhibit_label` is set after merge; consents include **sole-holder §228 explainer** and **execution** block; board minutes add **§141(e) materials** supplement and **remote quorum continuity** line—**signatures** and live **COI** amendments still out-of-band. **Record-date math** (DRS meeting − 10 days) must match **facts**. |
...
| Hippo / Ritual / TeamBoost | AGM said consent **“on file”** / **Exhibit A** | **Voidable** (if untrue) | Practice | **Low** (mitigated) | Default: minutes say **filing upon execution**; set `sole_stockholder_consent_exhibit_label` only when annexed. |
