...
**Layout note (May 2026+):** Counts and paths in this memo are frozen to the **2026-04-18** run. The generator now uses flat **`generated/<safe>/meetings/`**, a single **`generated/samples/`** tree when using **`--write-samples`** (PDF/CSV previews of representative outputs), and **`audit_text/`** is local-only (see **README.md**, **audit_reports/senior_dgcl_audit_2026-05-08.md**, **audit_reports/hard_audit_corpus_run.md**).
